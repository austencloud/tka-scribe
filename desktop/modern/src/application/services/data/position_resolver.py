...
class PositionResolver:
    ...
    def parse_position_key(self, position_key: str) -> tuple[str, str] | None:
        """
        ...
        try:
            ...
            logger.exception(f"Error parsing position key {position_key}: {e}")
            return None
    ...
    def normalize_position_key(self, position_key: str) -> str | None:
        """
    ...
    def extract_base_position(self, position_key: str) -> str | None:
        """
    ...
    def extract_end_position(self, position_key: str) -> str | None:
        """
