...
class SequenceDictionaryService:
    ...
    def get_word_for_sequence(self, sequence: SequenceData) -> str | None:
        ...
        try:
            ...
            logger.exception(f"Error getting word for sequence: {e}")
            return None
    ...
    def calculate_difficulty(self, sequence: SequenceData) -> int:
        ...
        try:
            ...
            logger.exception(f"Error calculating difficulty: {e}")
    ...
    def add_sequence_to_dictionary(self, sequence: SequenceData, word: str) -> bool:
        ...
        try:
            ...
            logger.exception(f"Error adding sequence to dictionary: {e}")
            return False
