...
from desktop.modern.src.application.services.backgrounds.aurora.blob_animation import (
    AuroraBlobAnimation,
)
from desktop.modern.src.application.services.backgrounds.aurora.sparkle_animation import (
    AuroraSparkleAnimation,
)
from desktop.modern.src.application.services.backgrounds.aurora.wave_effects import (
    AuroraWaveEffects,
)
