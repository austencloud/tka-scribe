...
class GraphEditorLogger:
    ...
    def error(self, message: str, context: dict[str, Any] | None = None, exception: Exception | None = None):
    ...
    def method_call(self, method_name: str, args: dict[str, Any] | None = None, result: Any = None):
    ...
    def validation_error(self, field: str, value: Any, error_message: str, context: dict[str, Any] | None = None):
    ...
    def state_change(self, from_state: Any, to_state: Any, context: dict[str, Any] | None = None):
    ...
    def performance_warning(self, operation: str, duration_ms: float, threshold_ms: float = 100, context: dict[str, Any] | None = None):
...
def log_error_with_context(logger: GraphEditorLogger, operation: str, context: dict[str, Any] | None = None):
    """
