...
results.forEach(file => {
  file.messages.forEach(msg => {
    if (msg.ruleId && (msg.ruleId.includes('no-unused-vars') || msg.ruleId.includes('unused-vars'))) {
      errors.push({
        file: file.filePath,
        line: msg.line,
        column: msg.column,
...
fs.writeFileSync('unused-vars-summary.json', JSON.stringify(fileGroups, null, 2));
