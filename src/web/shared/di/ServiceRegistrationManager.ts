...
export class ServiceRegistrationManager {
    ...
    registerCoreServices(container: ServiceContainer): void {
        ...
        const ILoggingService = createServiceInterface('ILoggingService', class {
        ...
        container.registerSingleton(ILoggingService, class ConsoleLoggingService {
            log(level: string, message: string, ...args: any[]): void {
        ...
        const IErrorHandlingService = createServiceInterface('IErrorHandlingService', class {
            handleError(error: Error, context?: any): void {}
            reportError(error: Error, context?: any): void {}
        });

        container.registerSingleton(IErrorHandlingService, class ErrorHandlingService {
            handleError(error: Error, context?: any): void {
        ...
        const IConfigurationService = createServiceInterface('IConfigurationService', class {
            get(key: string): any {}
            set(key: string, value: any): void {}
            getEnvironment(): string {}
        });

        container.registerSingleton(IConfigurationService, class ConfigurationService {
    ...
    registerDataServices(container: ServiceContainer): void {
        ...
        // Storage service
        const IStorageService = createServiceInterface('IStorageService', class {
        ...
        container.registerSingleton(IStorageService, class BrowserStorageService {
        ...
        const ISequenceDataService = createServiceInterface('ISequenceDataService', class {
            async getSequence(id: string): Promise<any> { return null; }
            async saveSequence(sequence: any): Promise<any> { return sequence; }
            async deleteSequence(id: string): Promise<boolean> { return false; }
            async listSequences(): Promise<any[]> { return []; }
        });

        container.registerSingleton(ISequenceDataService, class BrowserSequenceDataService {
            ...
            async saveSequence(sequence: any): Promise<any> {
                this.storageService.setItem(`sequence_${sequence.id}`, JSON.stringify(sequence));
                return sequence;
            }
    ...
    registerBusinessServices(container: ServiceContainer): void {
        ...
        const ISequenceManagementService = createServiceInterface('ISequenceManagementService', class {
            async createSequence(name: string, length: number): Promise<any> { return null; }
            async updateSequence(id: string, data: any): Promise<any> { return null; }
            async deleteSequence(id: string): Promise<boolean> { return false; }
        });

        container.registerSingleton(ISequenceManagementService, class SequenceManagementService {
        ...
        // Validation service
        const IValidationService = createServiceInterface('IValidationService', class {
            validateSequence(sequence: any): { isValid: boolean; errors: string[] } {
                return { isValid: true, errors: [] };
            }
        });

        container.registerSingleton(IValidationService, class ValidationService {
            validateSequence(sequence: any): { isValid: boolean; errors: string[] } {
                const errors: string[] = [];
    ...
    registerUIServices(container: ServiceContainer): void {
        ...
        // Theme service
        const IThemeService = createServiceInterface('IThemeService', class {
            getCurrentTheme(): string { return 'default'; }
            setTheme(theme: string): void {}
            getAvailableThemes(): string[] { return []; }
        });

        container.registerSingleton(IThemeService, class ThemeService {
        ...
        const INotificationService = createServiceInterface('INotificationService', class {
        ...
        container.registerSingleton(INotificationService, class NotificationService {
            showSuccess(message: string): void {
    ...
    registerWebServices(container: ServiceContainer): void {
        ...
        // Navigation service
        const INavigationService = createServiceInterface('INavigationService', class {
            navigate(path: string): void {}
            goBack(): void {}
            getCurrentPath(): string { return '/'; }
        });

        container.registerSingleton(INavigationService, class SvelteNavigationService {
            navigate(path: string): void {
                if (typeof window !== 'undefined') {
    ...
    registerUtilityServices(container: ServiceContainer): void {
        ...
        const IIdGeneratorService = createServiceInterface('IIdGeneratorService', class {
            generateId(): string { return ''; }
            generateUuid(): string { return ''; }
        });

        container.registerTransient(IIdGeneratorService, class IdGeneratorService {
            generateId(): string {
