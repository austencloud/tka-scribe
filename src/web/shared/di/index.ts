 ...
 */
export function defineService<T>(name: string, type: new (...args: any[]) => T) {
...
export class ContainerBuilder {
     ...
     */
    singleton<T>(serviceInterface: ServiceInterface<T>, implementation: new (...args: any[]) => T): this {
     ...
     */
    transient<T>(serviceInterface: ServiceInterface<T>, implementation: new (...args: any[]) => T): this {
