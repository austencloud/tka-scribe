// src/lib/constructor/services/StartPositionService.ts
...
import { beatsStore } from "$lib/constructor/stores/sequence/beatsStore.js";
import { browser } from "$app/environment";

export class StartPositionService {
  convertPictographToStartPosition(
    ...
    return {
      ...
      sequence_start_position:
        pictograph.startPos?.replace(/\d+/, "") || "alpha", // Store the base name
