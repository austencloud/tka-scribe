...
--gradient-cosmic: linear-gradient(135deg, 
  #1e3c72 0%,    /* Deep Space Blue */
  #2a5298 25%,   /* Navy Blue */
  #667eea 50%,   /* Periwinkle */
  #764ba2 75%,   /* Purple */
  #f093fb 100%   /* Bright Purple */
);
```
...
--background-gradient: linear-gradient(135deg, 
  #e6eaff 0%,    /* Light cosmic blue */
  #f1f3ff 25%,   /* Very light cosmic blue */
  #f8f9ff 50%,   /* Near white with blue tint */
  #f3f0ff 75%,   /* Light purple tint */
  #fdf2ff 100%   /* Very light purple */
);
```
