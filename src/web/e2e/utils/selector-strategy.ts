...
export const selectors = {
  ...
  app: {
    ...
    tabButton: (tabName: string) => `[data-test="tab-${tabName}"], button[data-tab="${tabName}"], button:has-text("${tabName}")`,
  ...
  pictograph: {
    ...
    gridPoint: (pointName: string) => `[data-test="grid-point-${pointName}"], [data-point-name="${pointName}"]`,
