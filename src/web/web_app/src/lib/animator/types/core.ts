 ...
 */
export type AnySequenceData = UnifiedSequenceData | SequenceData | WebAppSequenceData;
 ...
 */
export function convertMotionDataToPropAttributes(motionData: WebAppMotionData): PropAttributes {
	return {
 ...
 */
export function isUnifiedSequenceData(data: unknown): data is UnifiedSequenceData {
	return (
		data !== null &&
		data !== undefined &&
		typeof data === 'object' &&
 ...
 */
export function isWebAppSequenceData(data: unknown): data is WebAppSequenceData {
	return (
		data !== null &&
		data !== undefined &&
		typeof data === 'object' &&
 ...
 */
export function convertLegacyToUnified(legacyData: SequenceData): UnifiedSequenceData {
 ...
 */
export function convertWebAppToUnified(webAppData: WebAppSequenceData): UnifiedSequenceData {
	return {
		...webAppData,
 ...
 */
export function convertPropAttributesToMotionData(propAttrs: PropAttributes): WebAppMotionData {
	return {
 ...
 */
export function extractStepsFromUnified(data: UnifiedSequenceData): SequenceStep[] {
 ...
 */
export function extractMetaFromUnified(data: UnifiedSequenceData): SequenceMeta {
	return {
		id: data.id,
		word: data.word,
