/**
 * ExplorerScrollBehaviorService.ts
 *
...
import type { ExplorerScrollState } from '../../state/ExplorerScrollState.svelte';

export class ExplorerScrollBehaviorService {
	...
	constructor(private scrollState: ExplorerScrollState) {}
