  ...
  <div class="selectors">
    ...
    >
      ...
      <div class="selector-right">
        ...
        <i class="fas fa-{primarySequence ? 'check-circle' : 'chevron-right'}"
        ></i>
      </div>
    </button>
    ...
    >
      ...
      <div class="selector-right">
        ...
        <i class="fas fa-{secondarySequence ? 'check-circle' : 'chevron-right'}"
        ></i>
      </div>
    </button>
  </div>
...
<style>
  ...
  .color-dots .dot.green {
    background: #22c55e;
  }
  .color-dots .dot.purple {
    background: #a855f7;
  }
