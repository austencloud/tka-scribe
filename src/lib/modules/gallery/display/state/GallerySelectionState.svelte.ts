...
export interface IGallerySelectionState {
 ...
 */
export function createGallerySelectionState(): IGallerySelectionState {
...
export class GallerySelectionState implements IGallerySelectionState {
