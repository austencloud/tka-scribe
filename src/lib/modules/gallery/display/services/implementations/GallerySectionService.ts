...
import type {
  SectionConfig,
  SequenceSection,
} from "../../../shared/domain/models/gallery-models";
import type { IGallerySectionService } from "../contracts/IGallerySectionService";

@injectable()
export class GallerySectionService implements IGallerySectionService {
