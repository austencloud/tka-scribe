/**
 * Gallery Metadata Extractor Service
 *
...
import type {
  IGalleryMetadataExtractor,
  SequenceMetadata,
} from "../contracts/IGalleryMetadataExtractor";
...
@injectable()
export class GalleryMetadataExtractor implements IGalleryMetadataExtractor {
