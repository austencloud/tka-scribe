...
import type { IGalleryFilterService } from "../contracts/IGalleryFilterService";
...
@injectable()
export class GalleryFilterService implements IGalleryFilterService {
  applyFilter(
