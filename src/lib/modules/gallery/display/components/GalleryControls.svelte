<script lang="ts">
  ...
  const sortOptions = [
    ...
    { value: GallerySortMethod.DIFFICULTY_LEVEL, label: "Difficulty" },
    { value: GallerySortMethod.SEQUENCE_LENGTH, label: "Length" },
    { value: GallerySortMethod.DATE_ADDED, label: "Recently Added" },
