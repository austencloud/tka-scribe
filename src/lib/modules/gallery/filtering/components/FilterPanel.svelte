...
<script lang="ts">
  ...
  const sortOptions = [
    ...
    { id: GallerySortMethod.DIFFICULTY_LEVEL, label: "Difficulty" },
    { id: GallerySortMethod.DATE_ADDED, label: "Date Added" },
    { id: GallerySortMethod.SEQUENCE_LENGTH, label: "Length" },
  ];
