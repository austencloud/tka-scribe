/**
 * Optimized Gallery Service Implementation
 *
...
import type {
  IOptimizedGalleryService,
  PaginatedSequences,
  SequenceMetadata,
} from "../contracts/IOptimizedGalleryService";

@injectable()
export class OptimizedGalleryService implements IOptimizedGalleryService {
