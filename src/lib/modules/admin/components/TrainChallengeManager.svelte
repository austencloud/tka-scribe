...
<script lang="ts">
	...
	import type { ITrainChallengeService } from "$lib/modules/train/services/contracts/ITrainChallengeService";
	import type { TrainChallenge } from "$lib/modules/train/domain/models/TrainChallengeModels";
	import type { ChallengeDifficulty } from "$lib/shared/gamification/domain/models/achievement-models";
	import { PracticeMode } from "$lib/modules/train/domain/enums/TrainEnums";
	...
	import { SEED_CHALLENGES } from "$lib/modules/train/data/seed-challenges";
