 ...
 * - Complementary Mirroring → 16 letters (8 × 2, with flipped motion types and letters)
 *
...
@injectable()
export class MirroredRotatedComplementaryCAPExecutor implements ICAPExecutor {
  constructor(
