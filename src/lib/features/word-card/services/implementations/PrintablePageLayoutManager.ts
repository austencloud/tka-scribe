...
import type { IPrintablePageLayoutManager } from "../contracts/IPrintablePageLayoutManager";

@injectable()
export class PrintablePageLayoutManager implements IPrintablePageLayoutManager {
