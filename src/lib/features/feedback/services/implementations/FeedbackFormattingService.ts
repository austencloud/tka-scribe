...
import type { IFeedbackFormattingService } from "../contracts/IFeedbackFormattingService";
import { MODULE_DEFINITIONS } from "$lib/shared/navigation/state/navigation-state.svelte";

@injectable()
export class FeedbackFormattingService implements IFeedbackFormattingService {
  /**
