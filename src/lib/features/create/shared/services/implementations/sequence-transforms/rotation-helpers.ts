...
import { RotationDirection, MotionType } from "$lib/shared/pictograph/shared/domain/enums/pictograph-enums";
 ...
 */
export function reverseRotationDirection(direction: RotationDirection): RotationDirection {
 ...
 */
export function getToggledGridMode(current: GridMode, rotationAmount: number): GridMode {
...
export function rotateLocation(
	...
	for (let i = 0; i < steps; i++) {
		rotated = LOCATION_MAP_EIGHTH_CW[rotated as keyof typeof LOCATION_MAP_EIGHTH_CW] ?? rotated;
	}
	return rotated;
}
