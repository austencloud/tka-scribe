 ...
 */
export function rotateMotion(motion: MotionData, rotationAmount: number): MotionData {
	...
	const { arrowPlacementData: _, propPlacementData: __, ...motionWithoutPlacement } = motion;

	return createMotionData({
		...motionWithoutPlacement,
		startLocation: rotateLocation(motion.startLocation, rotationAmount) as GridLocation,
		endLocation: rotateLocation(motion.endLocation, rotationAmount) as GridLocation,
		arrowLocation: rotateLocation(motion.arrowLocation, rotationAmount) as GridLocation,
 ...
 */
export function swapMotionColor(motion: MotionData, targetColor: MotionColor): MotionData {
	return createMotionData({
		...motion,
		color: targetColor
	});
