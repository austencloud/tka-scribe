<!--
StaffPositionBadge - Badge showing Alpha/Beta/Gamma position type
-->
<script lang="ts">
	import { POSITION_COLORS, type PositionType } from "../../../../domain/constants/staff-visualizer-data";

	let { type }: { type: PositionType } = $props();
</script>
