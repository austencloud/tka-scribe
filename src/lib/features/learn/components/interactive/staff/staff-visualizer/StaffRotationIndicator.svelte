<!--
StaffRotationIndicator - Shows prospin/antispin rotation type
-->
<script lang="ts">
	import { ROTATION_COLORS, type RotationType } from "../../../../domain/constants/staff-visualizer-data";

	let { rotationType }: { rotationType: "prospin" | "antispin" } = $props();
</script>
