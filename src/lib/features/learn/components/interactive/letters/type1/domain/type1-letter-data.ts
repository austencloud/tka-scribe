 ...
 */
export function getLettersByMotionPattern(pattern: MotionPattern): Type1LetterData[] {
	switch (pattern) {
		case 'pro-pro':
 ...
 */
export function getMotionPatternForLetter(letter: Letter): MotionPattern | null {
