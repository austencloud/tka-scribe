...
<script lang="ts">
  ...
  const primaryBeatCount = $derived.by(() => {
    ...
    const normalized =
      normalizationService.separateBeatsFromStartPosition(primarySequence);
  ...
  const secondaryBeatCount = $derived.by(() => {
    ...
    const normalized =
      normalizationService.separateBeatsFromStartPosition(secondarySequence);
    return normalized.beats.length;
  });
</script>
...
<div class="selection-area">
  ...
  <div class="sequence-selectors">
    ...
    >
      ...
      <div class="card-action">
        <i class="fas fa-{primarySequence ? 'check-circle' : 'plus-circle'}"
        ></i>
      </div>
    </button>
    ...
    >
      ...
      <div class="card-action">
        <i class="fas fa-{secondarySequence ? 'check-circle' : 'plus-circle'}"
        ></i>
      </div>
    </button>
  </div>
  ...
  <div class="info-banner">
    ...
    <p>
      Select two sequences with the same beat count to overlay them. Perfect for
      comparing similar movements or analyzing timing differences.
    </p>
  </div>
</div>
