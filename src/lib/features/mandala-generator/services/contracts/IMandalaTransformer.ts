import type { Point, MandalaElement, TransformedElement } from '../../domain/models/mandala-element';
...
export interface IMandalaTransformer {
	 ...
	 */
	generateKaleidoscopePattern(element: MandalaElement, config: MandalaConfig): TransformedElement[];
	 ...
	 */
	transformAllElements(elements: MandalaElement[], config: MandalaConfig): TransformedElement[];
