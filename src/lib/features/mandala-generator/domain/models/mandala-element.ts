 ...
 */
export function serializeElement(element: MandalaElement): SerializedMandalaElement {
	return {
		id: element.id,
		type: element.type,
 ...
 */
export function deserializeElement(data: SerializedMandalaElement): MandalaElement {
	return {
		...data,
