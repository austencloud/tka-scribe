...
import type {
  ICAPLabelsFirebaseRepository,
  LabeledSequence,
} from "../contracts/ICAPLabelsFirebaseRepository";
 ...
 */
@injectable()
export class CAPLabelsFirebaseRepository implements ICAPLabelsFirebaseRepository {
