 ...
 */
@injectable()
export class RotationComparisonService implements IRotationComparisonService {
	checkRotations(
		b1Blue: ColorData,
		b1Red: ColorData,
		b2Blue: ColorData,
		...
		this.checkSwappedColorRotations(b1Blue, b1Red, b2Blue, b2Red, transformations);
	...
	private checkSameColorRotations(
		...
		const rotDirSameColors =
			b1Blue.propRotDir === b2Blue.propRotDir && b1Red.propRotDir === b2Red.propRotDir;
