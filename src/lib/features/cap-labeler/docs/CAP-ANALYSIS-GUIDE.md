...
> **Living Document**: This guide captures insights about CAP (Circular Alternating Permutation) analysis discovered during labeling sessions. Future AI agents and users should update this as new patterns are understood.
