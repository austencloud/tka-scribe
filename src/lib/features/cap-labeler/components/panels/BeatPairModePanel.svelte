<script lang="ts">
   ...
   * using the same component selection as whole-sequence mode,
...
<div class="beatpair-mode-builder">
  ...
  <!-- Component Grid with Integrated Intervals (shown when both beats selected) -->
  {#if hasBothBeats}
