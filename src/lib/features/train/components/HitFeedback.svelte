...
<style>
  ...
  .combo-display.high-combo {
    ...
    border-color: color-mix(
      in srgb,
      var(--semantic-warning, #eab308) 60%,
      transparent
    );
  ...
  .high-combo .combo-value {
    ...
    text-shadow: 0 0 10px
      color-mix(in srgb, var(--semantic-warning, #eab308) 50%, transparent);
  }
  ...
  .feedback-popup.hit {
    ...
    border: 3px solid
      color-mix(in srgb, var(--semantic-success, #22c55e) 80%, transparent);
    box-shadow: 0 0 30px
  ...
  @keyframes pulse-high-combo {
    ...
    50% {
      transform: scale(1.1);
      box-shadow: 0 0 40px
        color-mix(in srgb, var(--semantic-warning, #eab308) 60%, transparent);
    }
  }
