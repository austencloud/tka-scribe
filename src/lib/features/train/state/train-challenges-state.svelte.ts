...
import type { TrainChallenge, UserTrainChallengeProgress } from "../domain/models/TrainChallengeModels";
...
function createTrainChallengesState() {
	 ...
	 */
	async function loadChallenges(service: ITrainChallengeService): Promise<void> {
	 ...
	 */
	async function refreshChallenges(service: ITrainChallengeService): Promise<void> {
		isLoaded = false;
	 ...
	 */
	function updateProgress(challengeId: string, progress: UserTrainChallengeProgress) {
...
let challengesStateInstance: ReturnType<typeof createTrainChallengesState> | null = null;
...
export const trainChallengesState = {
	...
	loadChallenges(service: ITrainChallengeService) {
		return getChallengesState().loadChallenges(service);
	},
	refreshChallenges(service: ITrainChallengeService) {
...
export type TrainChallengesState = ReturnType<typeof createTrainChallengesState>;
