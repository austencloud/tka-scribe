<script lang="ts">
  /**
   * ChallengeTeaser - Mobile teaser for Today's Challenge
   * Tappable row that opens the full challenge in a slide-up drawer
   */
...
<style>
  ...
  .teaser:active {
    background: var(--surface-2026-active, rgba(255, 255, 255, 0.08));
  }
