/**
 * Animation3DPersistenceService Implementation
 *
...
import type {
  IAnimation3DPersistenceService,
  Animation3DPersistedState,
} from "../contracts/IAnimation3DPersistenceService";

const STORAGE_KEY = "tka-3d-animator-state";

@injectable()
export class Animation3DPersistenceService
  implements IAnimation3DPersistenceService
{
  /**
