/**
 * SequenceConverterService Implementation
 *
...
import type {
  ...
  BeatMotionConfigs,
} from "../contracts/ISequenceConverterService";

@injectable()
export class SequenceConverterService implements ISequenceConverterService {
  /**
