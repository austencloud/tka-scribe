/**
 * PropStateInterpolatorService Implementation
 *
...
import type { IPropStateInterpolatorService } from "../contracts/IPropStateInterpolatorService";
...
@injectable()
export class PropStateInterpolatorService
  implements IPropStateInterpolatorService
{
  constructor(
    ...
    @inject(ANIMATION_3D_TYPES.IMotionCalculatorService)
    private motionCalculator: IMotionCalculatorService
  ) {}
