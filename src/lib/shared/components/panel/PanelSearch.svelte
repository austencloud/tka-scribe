...
<style>
  ...
  .panel-search__input {
    ...
    background: var(--input-bg-current, rgba(255, 255, 255, 0.06));
    border: 1px solid var(--input-border-current, rgba(255, 255, 255, 0.1));
    border-radius: 12px;
    color: white;
    font-size: 14px;
  ...
  .panel-search__input:focus {
    outline: none;
    background: var(--input-focus-current, rgba(255, 255, 255, 0.08));
