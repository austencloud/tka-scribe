...
import type {
  ...
  RecordingResult,
  RecordingOptions,
} from "../contracts/IVideoRecordService";
...
// Singleton instance
let serviceInstance: VideoRecordService | null = null;

export function getVideoRecordService(): VideoRecordService {
  if (!serviceInstance) {
    serviceInstance = new VideoRecordService();
  }
