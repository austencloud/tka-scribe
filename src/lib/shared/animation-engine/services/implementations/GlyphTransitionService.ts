...
import type {
	IGlyphTransitionService,
	GlyphTransitionState,
	TransitionStateCallback,
} from "../contracts/IGlyphTransitionService";

const GLYPH_TRANSITION_DURATION_MS = 200;

export class GlyphTransitionService implements IGlyphTransitionService {
	...
	updateTarget(
		...
		if (this.state.displayedLetter !== null || this.state.displayedBeatNumber !== null) {
