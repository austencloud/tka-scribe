<script lang="ts">
	...
	function getTypeLabel(value: UserNotification["type"] | "all"): string {
		return notificationTypes.find((t) => t.value === value)?.label || "All Types";
	}
</script>
...
<div class="notification-filter">
	...
	{#if showTypeFilters}
		<div class="type-filter" transition:slide={{ duration: 200 }}>
			...
			<div class="chip-scroll desktop-only" role="group" aria-label="Filter by notification type">
...
{#if isTypeSheetOpen}
	<div class="sheet-overlay" onclick={() => (isTypeSheetOpen = false)} role="presentation">
		<div
			class="sheet"
