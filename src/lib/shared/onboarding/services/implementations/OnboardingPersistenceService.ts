...
import type {
  ...
  OnboardingStatus,
} from "../contracts/IOnboardingPersistenceService";
import {
  ...
  implements IOnboardingPersistenceService
{
  ...
  async loadStatus(): Promise<OnboardingStatus> {
    ...
    try {
      ...
      console.error(
        "❌ [OnboardingPersistenceService] Failed to load from Firebase:",
        error
      );
  ...
  async saveStatus(status: OnboardingStatus): Promise<void> {
    ...
    try {
      ...
      console.error(
        "❌ [OnboardingPersistenceService] Failed to save to Firebase:",
        error
      );
  ...
  async subscribe(callback: (status: OnboardingStatus) => void): Promise<() => void> {
    ...
    this.unsubscribe = onSnapshot(
      ...
      (error) => {
        console.error(
          "❌ [OnboardingPersistenceService] Subscription error:",
          error
        );
      }
    );
