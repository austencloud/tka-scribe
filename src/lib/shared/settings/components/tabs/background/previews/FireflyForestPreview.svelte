...
<style>
  ...
  .firefly-forest::after {
    ...
    background:
      ...
      radial-gradient(
        circle at 22% 35%,
        rgba(180, 255, 100, 1) 0%,
        rgba(150, 230, 80, 0.6) 4px,
        rgba(120, 200, 60, 0.2) 8px,
        transparent 12px
      ),
      radial-gradient(
        circle at 70% 45%,
        rgba(200, 255, 120, 1) 0%,
        rgba(170, 240, 90, 0.6) 3px,
        rgba(140, 210, 70, 0.2) 7px,
        transparent 11px
      ),
      radial-gradient(
        circle at 48% 65%,
        rgba(190, 255, 110, 1) 0%,
        rgba(160, 235, 85, 0.6) 4px,
        rgba(130, 205, 65, 0.2) 8px,
        transparent 12px
      ),
      /* Medium fireflies */
      radial-gradient(
          circle at 82% 30%,
          rgba(175, 250, 95, 0.9) 0%,
          rgba(145, 220, 75, 0.5) 3px,
          transparent 7px
        ),
      radial-gradient(
        circle at 15% 60%,
        rgba(185, 255, 105, 0.9) 0%,
        rgba(155, 230, 85, 0.5) 3px,
        transparent 7px
      ),
      radial-gradient(
        circle at 58% 38%,
        rgba(195, 255, 115, 0.85) 0%,
        rgba(165, 235, 90, 0.45) 2px,
        transparent 6px
      ),
      /* Small distant fireflies */
      radial-gradient(
          circle at 35% 50%,
          rgba(170, 245, 90, 0.7) 0%,
          rgba(140, 215, 70, 0.3) 2px,
          transparent 4px
        ),
      radial-gradient(
        circle at 88% 55%,
        rgba(180, 250, 100, 0.7) 0%,
        rgba(150, 220, 80, 0.3) 2px,
        transparent 4px
      ),
      radial-gradient(
        circle at 42% 78%,
        rgba(175, 248, 95, 0.65) 0%,
        rgba(145, 218, 75, 0.25) 2px,
        transparent 4px
      );
