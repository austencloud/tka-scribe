...
<script lang="ts">
	...
	const quizItems: QuizItem[] = [
		// Play mode quizzes
		{ id: "pictograph-to-letter", name: "Pictograph → Letter", category: "play", component: PictographToLetterQuiz },
		{ id: "letter-to-pictograph", name: "Letter → Pictograph", category: "play", component: LetterToPictographQuiz },
		{ id: "valid-next", name: "Valid Next Pictograph", category: "play", component: ValidNextPictographQuiz },
		// Concept quizzes (standalone)
		{ id: "grid-identification", name: "Grid Identification", category: "concept-quiz", component: GridIdentificationQuiz },
		{ id: "grid-point-tap", name: "Grid Point Tap", category: "concept-quiz", component: GridPointTapQuiz },
		{ id: "type1-letter", name: "Type 1 Letter Quiz", category: "concept-quiz", component: Type1LetterQuiz },
		{ id: "staff-identification", name: "Staff Identification", category: "concept-quiz", component: StaffIdentificationQuiz },
		{ id: "position-identification", name: "Position Identification", category: "concept-quiz", component: PositionIdentificationQuiz },
		{ id: "motion-identification", name: "Motion Identification", category: "concept-quiz", component: MotionIdentificationQuiz },
		{ id: "vtg-quiz", name: "VTG Quiz", category: "concept-quiz", component: VTGQuiz },
		{ id: "word-building", name: "Word Building Quiz", category: "concept-quiz", component: WordBuildingQuiz },
		// Full concept experiences
		{ id: "grid-experience", name: "Grid Experience", category: "concept-experience", component: GridConceptExperience },
		{ id: "vtg-experience", name: "VTG Experience", category: "concept-experience", component: VTGConceptExperience },
		{ id: "motions-experience", name: "Motions Experience", category: "concept-experience", component: MotionsConceptExperience },
		{ id: "positions-experience", name: "Positions Experience", category: "concept-experience", component: PositionsConceptExperience },
		{ id: "staff-experience", name: "Staff Experience", category: "concept-experience", component: StaffConceptExperience },
		{ id: "words-experience", name: "Words Experience", category: "concept-experience", component: WordsConceptExperience },
		{ id: "type1-experience", name: "Type 1 Experience", category: "concept-experience", component: Type1ConceptExperience },
	];
	...
	const conceptQuizzes = $derived(quizItems.filter(q => q.category === "concept-quiz"));
	const conceptExperiences = $derived(quizItems.filter(q => q.category === "concept-experience"));
</script>
		...
		<div class="quiz-container">
			...
			{#if completionMessage}
				<div class="completion-banner">
					{completionMessage}
					<button class="retry-btn" onclick={() => { completionMessage = null; }}>
						Retry
					</button>
				</div>
			{:else}
	...
	{:else}
		<div class="selector">
			...
			<section class="category">
				...
				<p class="category-desc">Complete lesson flows (intro → content → quiz)</p>
				<div class="quiz-grid">
					{#each conceptExperiences as quiz}
						<button class="quiz-card experience" onclick={() => selectQuiz(quiz)}>
							{quiz.name}
						</button>
					{/each}
				</div>
