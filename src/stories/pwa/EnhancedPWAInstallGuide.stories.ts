...
import EnhancedPWAInstallGuide from "$shared/mobile/components/EnhancedPWAInstallGuide.svelte";

const meta = {
  title: "PWA/EnhancedPWAInstallGuide",
  component: EnhancedPWAInstallGuide as any,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    backgrounds: {
...
} satisfies Meta<EnhancedPWAInstallGuide>;
