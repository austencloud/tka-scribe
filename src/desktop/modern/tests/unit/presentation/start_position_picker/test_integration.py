...
def integrated_system(
    main_window, mock_pictograph_pool, mock_command_processor, mock_event_bus
):
    ...
    with (
        patch(
            "core.service_locator.get_command_processor",
            return_value=mock_command_processor,
        ),
...
class TestSystemIntegration:
    ...
    def test_position_selection_command_flow(self, integrated_system):
        ...
        with patch(
            "core.commands.start_position_commands.SetStartPositionCommand"
    ...
    def test_advanced_picker_integration(self, integrated_system):
        ...
        assert (
            system["picker"].stacked_widget.currentWidget()
            == system["picker"].advanced_picker
        )
    ...
    def test_error_handling_integration(self, integrated_system):
        ...
        system["command_processor"].execute.return_value = Mock(
...
class TestUIIntegration:
    ...
    def test_complete_user_workflow(self, integrated_system):
        ...
        assert (
            system["picker"].stacked_widget.currentWidget()
            == system["picker"].basic_picker_widget
        )
...
class TestDataIntegration:
    ...
    def test_dataset_integration(self, integrated_system):
        ...
        with patch(
            "application.services.data.dataset_query.DatasetQuery"
        ) as mock_dataset:
            mock_service = Mock()
            ...
            option = EnhancedStartPositionOption(
                "test_position", system["pool"], "diamond"
            )
...
class TestErrorHandlingIntegration:
    ...
    def test_service_unavailable_handling(self, integrated_system):
        ...
        with (
            patch("core.service_locator.get_command_processor", return_value=None),
