...
def test_letter_type_determination():
    ...
    try:
        ...
        for letter in test_letters:
            ...
            if letter_type:
                print(f"     -> Found enum: {letter_type} (value: '{letter_type.value}')")
            else:
        ...
        pictograph_data = factory.create_pictograph_data_from_entry(test_entry, "diamond")
        print(f"   Created pictograph for 'A': letter_type = {pictograph_data.letter_type}")
