...
class IGraphEditorDataFlowManager(ABC):
    ...
    @abstractmethod
    def process_motion_type_change(self, beat_data: BeatData, arrow_color: str, new_motion_type: MotionType) -> BeatData:
        """
    ...
    @abstractmethod
    def process_location_change(self, beat_data: BeatData, arrow_color: str, new_location: str) -> BeatData:
        """
    ...
    @abstractmethod
    def validate_change(self, beat_data: BeatData, change_type: str, new_value: Any) -> bool:
        """
...
class IGraphEditorHotkeyManager(ABC):
    ...
    @abstractmethod
    def register_hotkey(self, key_sequence: str, action: Callable[[], None], description: str) -> None:
        """
...
class IGraphEditorEventManager(ABC):
    ...
    @abstractmethod
    def unregister_event_handler(self, event_type: str, handler: Callable[[Any], None]) -> None:
        """
...
class IGraphEditorValidationService(ABC):
    ...
    @abstractmethod
    def validate_change(self, current_data: BeatData, proposed_change: Dict[str, Any]) -> Tuple[bool, List[str]]:
        """
