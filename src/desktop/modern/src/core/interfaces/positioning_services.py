...
class IArrowLocationCalculator(ABC):
    ...
    @abstractmethod
    def calculate_location(self, motion: MotionData, pictograph_data: PictographData = None) -> Location:
        """
...
class IArrowAdjustmentCalculator(ABC):
    ...
    @abstractmethod
    def calculate_adjustment(self, arrow_data: ArrowData, pictograph_data: PictographData) -> QPointF:
        """
...
class IArrowPositioningOrchestrator(ABC):
    ...
    @abstractmethod
    def calculate_arrow_position(self, arrow_data: ArrowData, pictograph_data: PictographData) -> Tuple[float, float, float]:
        """
    ...
    @abstractmethod
    def calculate_all_arrow_positions(self, pictograph_data: PictographData) -> PictographData:
        """
