...
class CometTrajectory:
    ...
    def _move_comet(self) -> None:
        ...
        self.comet.tail.append((self.comet.position.x, self.comet.position.y, self.comet.size))
        
        # Update position
        self.comet.prev_position = Position2D(x=self.comet.position.x, y=self.comet.position.y)
        ...
        if (self.comet.position.x < -0.2 or self.comet.position.x > 1.2 or 
            self.comet.position.y < -0.2 or self.comet.position.y > 1.2):
