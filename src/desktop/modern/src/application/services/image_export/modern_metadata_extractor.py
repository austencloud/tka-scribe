...
class ModernMetadataExtractor(ISequenceMetadataExtractor):
    """
    ...
    def extract_sequence_data(self, file_path: Path) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            ...
            logger.error(f"Error extracting sequence data from {file_path}: {e}", exc_info=True)
            return None
    ...
    def get_difficulty_level(self, sequence_data: List[Dict[str, Any]]) -> int:
        ...
        try:
            ...
            logger.debug(f"Calculated difficulty level: {base_difficulty} for sequence of length {sequence_length}")
    ...
    def _calculate_complexity_score(self, sequence_data: List[Dict[str, Any]]) -> float:
        ...
        try:
            ...
            for beat in sequence_data:
                ...
                if current_direction and prev_direction and current_direction != prev_direction:
                    direction_changes += 1
