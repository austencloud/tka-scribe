    ...
    def create_legacy_motion_attributes(motion: Optional[MotionData]) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "start_ori": (
                    motion.start_ori.value
                    if hasattr(motion.start_ori, "value")
                    else str(motion.start_ori)
                ),
                "end_ori": (
                    motion.end_ori.value
                    if hasattr(motion.end_ori, "value")
                    else str(motion.end_ori)
                ),
