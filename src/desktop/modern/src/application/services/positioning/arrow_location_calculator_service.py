...
class ArrowLocationCalculatorService(IArrowLocationCalculator):
    ...
    def calculate_location(self, motion: MotionData, pictograph_data: Optional[PictographData] = None) -> Location:
        """
        ...
        if motion.motion_type == MotionType.STATIC:
            ...
            logger.warning(f"Unknown motion type: {motion.motion_type}, using start location")
    ...
    def _calculate_shift_location(self, motion: MotionData) -> Location:
        ...
        calculated_location = self._shift_direction_pairs.get(location_pair, motion.start_loc)
    ...
    def _calculate_dash_location(self, motion: MotionData, pictograph_data: Optional[PictographData]) -> Location:
        """
