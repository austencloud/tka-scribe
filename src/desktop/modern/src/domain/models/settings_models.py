...
class SettingsData:
    ...
    beat_layouts: Dict[int, BeatLayoutData] = field(default_factory=dict)  # keyed by sequence length
    image_export: ImageExportSettingsData = field(default_factory=ImageExportSettingsData)
    codex_export: CodexExportSettingsData = field(default_factory=CodexExportSettingsData)
    ...
    def set_beat_layout(self, sequence_length: int, layout: BeatLayoutData) -> "SettingsData":
