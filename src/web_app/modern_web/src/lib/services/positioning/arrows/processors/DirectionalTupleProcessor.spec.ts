...
import { DirectionalTupleCalculator, QuadrantIndexCalculator, DirectionalTupleProcessor } from './DirectionalTupleProcessor';
import { MotionType, RotationDirection, Location, Orientation } from '$lib/domain/enums';
