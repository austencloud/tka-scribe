...
This document explains the different types of Circular Auto-generative Patterns (CAPs) and how the detection system classifies them.
...
Neither! They're different creative choices. Strict CAPs have perfect mathematical symmetry. Modular sequences have intentional variation that creates visual interest while maintaining circularity.
