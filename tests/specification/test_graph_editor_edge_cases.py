    ...
    def test_rapid_button_clicking_contract(self):
        ...
        try:
            for i in range(50):  # Simulate rapid clicking
                ...
                graph_editor._set_orientation(
                    "red", "CLOCK" if i % 3 == 0 else "COUNTER"
                )
            success = True
        except Exception as e:
            success = False
        ...
        ), f"Rapid interactions too slow: {interaction_time:.3f}s"
...
class TestGraphEditorMemoryAndPerformance:
    ...
    def test_performance_degradation_contract(self):
        ...
        ), f"Performance degraded too much: {performance_ratio:.2f}x slower"
