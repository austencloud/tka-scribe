...
class SequenceBuilder:
    ...
    def for_error_case_test(self):
        ...
        return (self
                ...
                .with_metadata({"test_type": "error_case", "priority": "high"}))
...
class WorkflowBuilder:
    ...
    def add_sequence_step(self, sequence_spec: Dict[str, Any]):
        ...
        self._steps.append(step)
        logger.debug(f"WorkflowBuilder: added sequence step")
        return self
...
def complete_workflow(position: str = "alpha1_alpha1", length: int = 3) -> Dict[str, Any]:
    """
