...
class OptionPickerPage(BasePage):
    ...
    def get_available_options(self) -> List[str]:
        ...
        try:
            ...
            # Strategy 2: Try alternative method names
            for method_name in ['getAvailableOptions', 'available_options', 'get_options']:
                if hasattr(picker, method_name):
    ...
    def get_option_details(self, option_identifier: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for method_name in ['get_option_details', 'getOptionDetails', 'option_info']:
                if hasattr(picker, method_name):
    ...
    def _find_option_picker(self):
        ...
        for child in children:
            ...
            if "option" in class_name and "picker" in class_name and "section" not in class_name:
                logger.debug(f"Found option picker component: {child.__class__.__name__}")
                return child
    ...
    def _validate_picker_functionality(self, picker) -> bool:
        ...
        expected_attributes = [
            'select_option', 'selectOption', 'choose_option',
