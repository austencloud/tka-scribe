...
class TestSequenceBrowserSorting:
    ...
    def test_sort_sequences_alphabetical(self, sequence_browser_panel, sample_sequences):
        """Test alphabetical sorting of sequences."""
        sorted_sequences = sequence_browser_panel._sort_sequences(sample_sequences, "alphabetical")
    ...
    def test_sort_sequences_by_length(self, sequence_browser_panel, sample_sequences):
        ...
        sorted_sequences = sequence_browser_panel._sort_sequences(sample_sequences, "length")
    ...
    def test_sort_sequences_by_level(self, sequence_browser_panel, sample_sequences):
        ...
        sorted_sequences = sequence_browser_panel._sort_sequences(sample_sequences, "level")
    ...
    def test_sort_sequences_by_date_added(self, sequence_browser_panel, sample_sequences):
        """Test sorting sequences by date added (newest first)."""
        sorted_sequences = sequence_browser_panel._sort_sequences(sample_sequences, "date_added")
    ...
    def test_sort_sequences_default_fallback(self, sequence_browser_panel, sample_sequences):
        """Test that unknown sort method falls back to alphabetical."""
        sorted_sequences = sequence_browser_panel._sort_sequences(sample_sequences, "unknown_method")
...
class TestSequenceBrowserSectioning:
    ...
    def test_get_section_key_alphabetical(self, sequence_browser_panel, sample_sequences):
    ...
    def test_group_sequences_into_sections_alphabetical(self, sequence_browser_panel, sample_sequences):
        """Test grouping sequences into alphabetical sections."""
        sections = sequence_browser_panel._group_sequences_into_sections(sample_sequences, "alphabetical")
    ...
    def test_group_sequences_into_sections_length(self, sequence_browser_panel, sample_sequences):
        """Test grouping sequences into length sections."""
        sections = sequence_browser_panel._group_sequences_into_sections(sample_sequences, "length")
    ...
    def test_group_sequences_into_sections_level(self, sequence_browser_panel, sample_sequences):
        """Test grouping sequences into level sections."""
        sections = sequence_browser_panel._group_sequences_into_sections(sample_sequences, "level")
    ...
    def test_group_sequences_into_sections_date_added(self, sequence_browser_panel, sample_sequences):
        """Test grouping sequences into date sections."""
        sections = sequence_browser_panel._group_sequences_into_sections(sample_sequences, "date_added")
...
class TestSequenceBrowserIntegration:
    ...
    def test_sort_method_change_integration(self, sequence_browser_panel, sample_sequences):
        ...
        with patch.object(sequence_browser_panel, '_clear_grid'), \
             patch.object(sequence_browser_panel, '_add_section_header') as mock_add_header, \
             patch.object(sequence_browser_panel, '_create_sequence_thumbnail') as mock_create_thumbnail:
    ...
    def test_show_sequences_with_sort_method(self, sequence_browser_panel, sample_sequences):
        """Test that show_sequences properly applies sorting."""
        # Mock the internal methods
        with patch.object(sequence_browser_panel, '_sort_and_display_sequences') as mock_sort_display:
            sequence_browser_panel.show_sequences(sample_sequences, FilterType.ALL_SEQUENCES)
...
class TestSequenceBrowserEdgeCases:
    ...
    def test_sort_sequences_with_none_values(self, sequence_browser_panel):
        ...
        sequences = [
            SequenceData(id="seq1", word=None, sequence_length=None, level=None, date_added=None),
            SequenceData(id="seq2", word="Apple", sequence_length=3, level=1, date_added=datetime(2023, 1, 15))
        ]
        
        # Should not crash with None values
        sorted_sequences = sequence_browser_panel._sort_sequences(sequences, "alphabetical")
    ...
    def test_get_section_key_with_none_values(self, sequence_browser_panel):
        ...
        seq = SequenceData(id="seq1", word=None, sequence_length=None, level=None, date_added=None)
        
        # Should return fallback values
        assert sequence_browser_panel._get_section_key(seq, "alphabetical") == "?"
        assert sequence_browser_panel._get_section_key(seq, "length") == "Unknown Length"
        assert sequence_browser_panel._get_section_key(seq, "level") == "Unknown Level"
        assert sequence_browser_panel._get_section_key(seq, "date_added") == "Unknown Date"

    def test_group_empty_sequences(self, sequence_browser_panel):
        """Test grouping empty sequence list."""
        sections = sequence_browser_panel._group_sequences_into_sections([], "alphabetical")
        assert sections == {}
