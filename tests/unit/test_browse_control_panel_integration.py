...
class TestModernSortWidget:
    ...
    def test_sort_method_state_persistence(self, sort_widget, mock_state_service):
        ...
        mock_state_service.set_sort_method.assert_called_once_with(SortMethod.DIFFICULTY_LEVEL)
...
class TestControlPanelSequenceBrowserIntegration:
    ...
    def test_sort_change_propagation(self, sequence_browser_panel, sample_sequences):
        ...
        with patch.object(sequence_browser_panel, '_sort_and_display_sequences') as mock_display:
    ...
    def test_navigation_sidebar_updates_on_sort(self, sequence_browser_panel, sample_sequences):
        ...
        with patch.object(sequence_browser_panel, '_clear_grid'), \
             patch.object(sequence_browser_panel, '_create_sequence_thumbnail') as mock_create:
    ...
    def test_control_panel_state_synchronization(self, sequence_browser_panel, mock_state_service):
...
class TestSortingStateManagement:
    ...
    def test_sort_method_enum_conversion(self, mock_state_service):
        ...
        mock_state_service.set_sort_method.assert_called_once_with(SortMethod.SEQUENCE_LENGTH)
