    ...
    try:
        ...
        for i, thumbnail in enumerate(thumbnails):
            ...
            if layout:
                ...
                print(
                    f"  {i:2d}: Container={container_height:3d}px, Content={total_content:3d}px {'❌' if is_clipped else '✅'}"
                )
        ...
        if clipped_count == 0:
            ...
            print(
                "⚠️ Some thumbnails are clipped - content height exceeds container height"
            )
