...
class TestPositionMatchingServiceRefactor:
    ...
    def test_glyph_data_generation(self, service_with_mock_dataset):
        ...
        with patch(
            "application.services.data.glyph_data_service.GlyphDataService"
        ) as mock_glyph_service:
    ...
    def test_rotation_direction_parsing(self, service_with_mock_dataset):
        ...
        assert (
            service._parse_rotation_direction("ccw")
            == RotationDirection.COUNTER_CLOCKWISE
        )
        assert (
            service._parse_rotation_direction("no_rot") == RotationDirection.NO_ROTATION
        )
        assert (
            service._parse_rotation_direction("unknown")
