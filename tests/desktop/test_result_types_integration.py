"""
Integration tests for Result types and refactored services.

Tests the new error handling architecture with Result types.
"""
...
class TestCoordinateTypes:
    """Test coordinate type conversion utilities."""
...
class TestDataService:
    ...
    def test_data_service_load_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = DataConfig(temp_path, diamond_csv, temp_path / "BoxPictographDataframe.csv")
...
class TestAppConfiguration:
    ...
    def test_app_config_creation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Create data config
            data_config = DataConfig(temp_path, diamond_csv, temp_path / "BoxPictographDataframe.csv")
