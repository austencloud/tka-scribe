...
class TestValidationIntegration:
    ...
    def test_validation_error_aggregation(self):
        ...
        from desktop.core.validation.common_validators import validate_user_input
