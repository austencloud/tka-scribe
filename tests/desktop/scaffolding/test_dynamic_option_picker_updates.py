...
from desktop.presentation.components.option_picker.beat_data_loader import BeatDataLoader
...
class TestDynamicOptionPickerUpdates:
    ...
    def test_sequence_to_legacy_format_conversion(self, app):
        ...
        construct_tab = Mock(spec=ConstructTab)
        ...
        construct_tab._convert_sequence_to_legacy_format = (
            ConstructTab._convert_sequence_to_legacy_format
        )
