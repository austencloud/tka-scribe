...
class TestDIContainerContracts:
    ...
    def test_workbench_services_integration_contract(self):
        ...
        try:
            from desktop.core.dependency_injection.di_container import DIContainer, reset_container
            from desktop.presentation.factories.workbench_factory import configure_workbench_services
            from desktop.core.interfaces.core_services import ILayoutService, IUIStateManagementService
            from desktop.core.interfaces.workbench_services import (
                ISequenceWorkbenchService, IFullScreenService, IBeatDeletionService,
                IGraphEditorService, IDictionaryService
            )
            from desktop.application.services.layout.layout_management_service import LayoutManagementService
            from desktop.application.services.ui.ui_state_management_service import UIStateManagementService
