...
def run_basic_component_tests():
    ...
    from desktop.presentation.components import ViewableComponentBase, AsyncViewableComponentBase
...
def run_option_picker_tests():
    ...
    from desktop.presentation.components import ViewableComponentBase
    from desktop.presentation.components.option_picker import OptionPicker
    from desktop.core.dependency_injection.di_container import DIContainer
    from desktop.core.interfaces.core_services import ILayoutService
    from unittest.mock import Mock
