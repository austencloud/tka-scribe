...
class UISettingsManager:
    ...
    def _initialize_services(self):
        ...
        from desktop.modern.src.application.services.settings.background_settings_manager import (
            BackgroundSettingsManager,
        )
        from desktop.modern.src.application.services.settings.beat_layout_settings_manager import (
            BeatLayoutSettingsManager,
        )
        from desktop.modern.src.application.services.settings.image_export_settings_manager import (
            ImageExportSettingsManager,
        )
        from desktop.modern.src.application.services.settings.prop_type_settings_manager import (
            PropTypeSettingsManager,
        )
        from desktop.modern.src.application.services.settings.user_profile_settings_manager import (
            UserProfileSettingsManager,
        )
        from desktop.modern.src.application.services.settings.visibility_settings_manager import (
