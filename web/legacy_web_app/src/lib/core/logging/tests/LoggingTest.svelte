...
<script lang="ts">
  ...
  import {
    ...
    ErrorSeverity,
    ErrorCategory,
  } from "$legacyLib/core/logging";
  import LogViewer from "$legacyLib/components/logging/LogViewer.svelte";
...
<div class="logging-test">
  ...
  <div class="test-controls">
    ...
    >
    <button on:click={testDomainSpecificLogging}
      >Test Domain-Specific Logging</button
    >
