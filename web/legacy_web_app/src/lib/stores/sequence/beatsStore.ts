 ...
 * Use sequenceStore from '$legacyLib/state/stores/sequence/sequenceAdapter' instead.
 */
...
export const beatsStore: Writable<LegacyBeatData[]> = {
  subscribe: derived(sequenceStore, ($store) =>
    $store.beats.map(convertToLegacyBeat)
  ).subscribe,
