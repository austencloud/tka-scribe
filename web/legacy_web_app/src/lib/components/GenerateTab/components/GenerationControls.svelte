<script lang="ts">
  ...
  import type { CAPType } from "$legacyLib/state/machines/sequenceMachine/types";
  ...
  // Example: import { sequenceSelectors, sequenceActions } from '$legacyLib/state/machines/sequenceMachine';
