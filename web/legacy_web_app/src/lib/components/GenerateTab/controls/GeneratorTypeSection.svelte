...
<script lang="ts">
  import { sequenceSelectors } from "$legacyLib/state/machines/sequenceMachine";
  import { settingsStore as newSettingsStore } from "$legacyLib/state/stores/settingsStore";
...
<section class="control-section generator-type-section">
  ...
  <div class="generator-type-toggle">
    <GeneratorToggle
      ...
      onChange={(value) => handleGeneratorTypeChange(value)}
    />
  </div>
</section>
