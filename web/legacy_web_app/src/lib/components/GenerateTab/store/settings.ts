...
export const generatorType = derived(
  { subscribe },
  ($settings) => $settings.generatorType
);

export const numBeats = derived(
  { subscribe },
  ($settings) => $settings.numBeats
);

export const turnIntensity = derived(
  { subscribe },
  ($settings) => $settings.turnIntensity
);

export const propContinuity = derived(
  { subscribe },
  ($settings) => $settings.propContinuity
);
