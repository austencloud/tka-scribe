...
<div class="container" class:dark={isDarkTheme}>
  ...
  <div class="sequence-controls">
    ...
    <div class="control-group">
      <button onclick={generateSequence} disabled={isGenerating}
        >Generate Sequence</button
      >
      <button onclick={clearSequence} disabled={sequence.beats.length === 0}
  ...
  <div class="add-beat-form">
    ...
    >
      ...
      />
      <button type="submit" disabled={!beatName.trim() || isGenerating}
        >Add Beat</button
      >
    </form>
  </div>
  ...
  <div class="sequence-display">
    ...
    {#if sequence.beats.length === 0}
      <div class="empty-state">
        No beats in sequence. Generate or add beats to get started.
      </div>
    {:else}
      <ul class="beat-list">
          ...
          >
            <div class="beat-content">
              ...
              <span class="beat-name"
                >{beat.letter || `Beat ${beat.number}`}</span
              >
  ...
  <div class="selection-info">
    ...
    {#if sequence.selectedBeatIds.length === 0}
      <div class="empty-state">
        No beats selected. Click on a beat to select it.
      </div>
    {:else}
