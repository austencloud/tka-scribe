...
<div class="layout-debugger">
  <div class="section">
    ...
    <div class="info-grid">
      ...
      <div class="info-value user-agent">
        {formatUserAgent($deviceInfo.userAgent)}
      </div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="breakpoints">
      ...
      <div
        class="breakpoint"
        class:active={$deviceInfo.width >= 576 && $deviceInfo.width < 768}
      >
      ...
      <div
        class="breakpoint"
        class:active={$deviceInfo.width >= 768 && $deviceInfo.width < 992}
      >
      ...
      <div
        class="breakpoint"
        class:active={$deviceInfo.width >= 992 && $deviceInfo.width < 1200}
      >
