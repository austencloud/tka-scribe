<script lang="ts">
  ...
  function testHapticFeedback(
    type: "selection" | "success" | "warning" | "error" | "navigation"
  ) {
...
<div class="haptic-tab">
  ...
  <div class="settings-section">
    ...
    <ul class="feedback-uses">
      <li>
        <i class="fa-solid fa-hand-pointer"></i> When selecting pictographs
      </li>
      <li><i class="fa-solid fa-toggle-on"></i> When toggling settings</li>
      <li>
        <i class="fa-solid fa-check-circle"></i> When completing a sequence
      </li>
      <li>
        <i class="fa-solid fa-share-alt"></i> When sharing/exporting content
      </li>
      <li>
        <i class="fa-solid fa-exchange-alt"></i> When navigating between sections
      </li>
