<script lang="ts">
  import { settingsStore } from "$legacyLib/state/stores/settings/settings.store";
  import { userContainer } from "$legacyLib/state/stores/user/UserContainer";
  ...
  import { uiStore } from "$legacyLib/components/WriteTab/stores/uiStore";
  import {
    getImageExportSettings,
    updateImageExportSettings,
  } from "$legacyLib/state/image-export-settings.svelte";
  ...
  $effect(() => {
    if (browser) {
      ...
      try {
        ...
        console.error(
          "Failed to load remember save location preference:",
          error
        );
      }
    }
  ...
  function toggleHapticFeedback() {
    if (browser && settings.hapticFeedback)
  ...
  <div class="settings-section">
    ...
    <div class="setting-item">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Vibration feedback for touch interactions</span
        >
      </div>
    ...
    <div class="setting-item">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Remember last directory used for image exports</span
        >
      </div>
      <div class="setting-control">
        <label class="switch">
