...
<script lang="ts">
  ...
  import { saveImageExportSettings } from "$legacyLib/state/image-export-settings.svelte";
  import type { ImageExportSettings } from "$legacyLib/state/image-export-settings.svelte";
  ...
  import { isMobileDevice as checkMobileDevice } from "$legacyLib/utils/fileSystemUtils";
  ...
  const buttonSettings = [
    ...
    },
    {
      label: "Word",
      key: "addWord",
      tooltip: "Add the sequence word as a title",
    },
    {
