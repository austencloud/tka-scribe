<script lang="ts">
  ...
  let appIsLoading = $state(
    props.appIsLoading !== undefined ? props.appIsLoading : true
  );
  ...
  $effect(() => {
    if (
      ...
      props.backgroundType !== backgroundType
    ) {
      backgroundType = props.backgroundType;
    }
    if (
      props.appIsLoading !== undefined &&
      props.appIsLoading !== appIsLoading
    ) {
