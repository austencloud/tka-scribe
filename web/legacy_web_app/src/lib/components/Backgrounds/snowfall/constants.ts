...
export const backgroundGradient = CoreConfig.background.gradientStops.map(
  (stop) => ({
    stop: stop.position,
    color: stop.color,
  })
...
export const performanceThresholds = {
  ...
  criticalPerformanceThreshold:
    CoreConfig.performance.criticalPerformanceThreshold,
};
