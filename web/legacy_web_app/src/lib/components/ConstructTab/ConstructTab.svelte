...
<script lang="ts">
  import SharedWorkbench from "$legacyLib/components/SequenceWorkbench/SharedWorkbench.svelte";
  import { workbenchStore } from "$legacyLib/state/stores/workbenchStore";
  import type { ButtonDefinition } from "$legacyLib/components/SequenceWorkbench/ButtonPanel/types";
  import { openSequenceFullScreen } from "$legacyLib/stores/sequence/fullScreenStore";
