<script lang="ts">
  ...
  function updateLayout() {
    ...
    const availableWidth =
      (viewportWidth - safeInsetLeft - safeInsetRight) * 0.95;
    const availableHeight =
      (viewportHeight - safeInsetTop - safeInsetBottom) * 0.9; // Leave room for header/footer
...
<div
  class="fullscreen-overlay-container fullscreen-beat-container"
...
>
  ...
  <div class="sequence-grid" bind:this={gridRef}>
    ...
    {#each beats as beat, index}
      ...
      <div
        class="grid-item"
        style="grid-column: {position.col}; grid-row: {position.row + 1};"
      >
        <div class="pictograph-container">
          <Pictograph
            pictographData={{
