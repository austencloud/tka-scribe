...
import * as downloadUtils from "$legacyLib/components/Pictograph/export/downloadUtils";
import * as toastManager from "$legacyLib/components/shared/ToastManager.svelte";
...
vi.mock("$legacyLib/components/Pictograph/export/downloadUtils", () => ({
  downloadImage: vi.fn(),
}));
...
describe("DownloadHandler", () => {
  ...
  it("should download a sequence image successfully", async () => {
    ...
    vi.mocked(downloadUtils.downloadImage).mockResolvedValue({ success: true });
