  ...
  >
    ...
    >
      ...
      <div class="modal-content">
        <p>
          Are you sure you want to clear the entire sequence? This will remove
          all beats and reset the start position.
        </p>
      ...
      <div class="modal-footer">
        ...
        <button class="confirm-button danger" onclick={handleConfirm}>
          Clear
        </button>
      </div>
    </div>
...
<style>
  ...
  .clear-button:active {
    ...
    background-color: var(
      --tkc-button-panel-background-active,
      #1e1e21
    ); /* Darker when pressed */
    box-shadow:
  ...
  .icon-wrapper i.fa-eraser {
    font-size: calc(
      var(--button-size-factor, 1) * var(--base-icon-size)
    ); /* Dynamic icon size */
