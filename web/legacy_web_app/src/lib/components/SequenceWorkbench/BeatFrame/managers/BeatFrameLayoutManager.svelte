...
<script lang="ts">
  ...
  import type { BeatFrameLayoutOptions } from "$legacyLib/types/BeatFrameLayoutOptions";
  ...
  function checkForOverflow() {
    ...
    const sequenceWidget =
      container.closest(".sequence-widget") || container.parentElement;
      ...
      setTimeout(() => {
        if (beatFrame) {
          ...
          console.log("DOM state after update:", {
            ...
            parentHasScrollableClass:
              beatFrame.closest(".scrollable-active") !== null,
