    ...
    >
      <div class="popup-content">
        <div class="option-buttons">
          ...
          <button
            class="option-button clear-sequence"
          ...
          >
            ...
            <div class="option-text">
              ...
              <span class="option-description"
                >Remove all beats and reset start position</span
              >
            </div>
          </button>
        </div>
...
<style>
  ...
  .popup-container::after {
    ...
    border-top: calc((1 - var(--position-above, 1)) * 1px) solid
      rgba(255, 255, 255, 0.1);
    border-left: calc((1 - var(--position-above, 1)) * 1px) solid
      rgba(255, 255, 255, 0.1);
    border-bottom: calc(var(--position-above, 1) * 1px) solid
      rgba(255, 255, 255, 0.1);
    border-right: calc(var(--position-above, 1) * 1px) solid
      rgba(255, 255, 255, 0.1);
  }
  ...
  .popup-container::before {
    ...
    background: radial-gradient(
      circle,
      rgba(108, 156, 233, 0.2) 0%,
      rgba(108, 156, 233, 0) 70%
    );
    transform: translateX(-50%);
