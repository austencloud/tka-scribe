...
<script lang="ts">
  import {
    ...
    turnsStore,
    type Direction,
  } from "$legacyLib/stores/sequence/turnsStore";
  ...
  <div class="turns-box-header">
    ...
    <button
      ...
      style="--color: {colorConfig.primary};
			   --background-color: {direction === 'counterclockwise'
        ? colorConfig.primary
        : 'white'};"
    ...
    >
      <img
        class="icon"
        src={iconPaths.counterClockwise}
        alt="Counter-clockwise Icon"
      />
    </button>

    <!-- Label -->
    <div class="header-label" style="color: {colorConfig.primary};">
      {colorConfig.text}
    </div>
    ...
    <button
      class="direction-button"
      style="--color: {colorConfig.primary};
			   --background-color: {direction === 'clockwise'
        ? colorConfig.primary
        : 'white'};"
