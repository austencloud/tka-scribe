...
<script lang="ts">
  ...
  import ConstructTab from "$legacyLib/components/ConstructTab/ConstructTab.svelte";
  import GenerateTabContent from "$legacyLib/components/GenerateTab/components/GenerateTabContent.svelte";
