<script lang="ts">
  ...
  import {
    learnStore,
    quizResults,
  } from "$legacyLib/state/stores/learn/learnStore";
  ...
  <div class="results-container">
    ...
    >
      ...
      <div class="recommendation">
        {#if isPassing}
          <p>
            Ready to continue your learning journey? Try another lesson or
            challenge yourself again!
          </p>
        {:else}
          <p>
            Practice makes perfect! Review the material and try again to improve
            your score.
          </p>
        {/if}
      </div>
    ...
    >
      <BackButton on:click={() => learnStore.goBackToSelector()}
        >Back to Lessons</BackButton
      >
      <StartOverButton on:click={() => learnStore.startOver()}
        >Try Again</StartOverButton
      >
    </div>
  </div>
