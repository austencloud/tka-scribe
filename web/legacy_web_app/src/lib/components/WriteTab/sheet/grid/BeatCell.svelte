<script lang="ts">
  ...
  import { selectedBeat } from "../../stores/selectionStore";
  import { uiStore } from "../../stores/uiStore";

  let { row, col, beat, onclick } = $props<{
    row: number;
    col: number;
    beat?: Beat;
  ...
  const isSelected = $derived($selectedBeat?.row === row && $selectedBeat?.col === col);
