<!-- src/lib/components/GalleryTab/SequenceGrid/Thumbnail.svelte -->
<script lang="ts">
  import type { SequenceData } from "$legacyLib/stores/browseTab/browseTabStore";
...
<style>
  ...
  .thumbnail.selected {
    ...
    box-shadow: 0 0 0 2px
      var(--primary-color-transparent, rgba(74, 144, 226, 0.3));
  }
