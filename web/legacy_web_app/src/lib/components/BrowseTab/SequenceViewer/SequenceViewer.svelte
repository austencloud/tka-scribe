<!-- src/lib/components/GalleryTab/SequenceViewer/SequenceViewer.svelte -->
<script lang="ts">
  import {
    browseTabStore,
    ...
    <div class="viewer-header">
      ...
      <div class="sequence-metadata">
        ...
        {#if sequence.metadata.level}
          <span
            class="metadata-item difficulty"
            data-level={sequence.metadata.level}
          >
          ...
          <div class="details-grid">
            ...
            {#if sequence.metadata.startingPosition}
              <div class="detail-item">
                ...
                <span class="detail-value"
                  >{sequence.metadata.startingPosition}</span
                >
              </div>
            {/if}
            ...
            {#if sequence.metadata.length}
              <div class="detail-item">
                ...
                <span class="detail-value"
                  >{sequence.metadata.length} beats</span
                >
              </div>
            {/if}
