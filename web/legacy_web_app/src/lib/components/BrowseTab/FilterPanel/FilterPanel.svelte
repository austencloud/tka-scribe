<!-- src/lib/components/GalleryTab/FilterPanel/FilterPanel.svelte -->
<script lang="ts">
  import {
    browseTabStore,
    type FilterCriteria,
      ...
      <div class="button-grid">
        {#each startingPositions as position}
          <button
            ...
            on:click={() =>
              applyFilter({ type: "startingPosition", value: position })}
          >
            {position}
          </button>
        {/each}
      ...
      <div class="letter-grid">
        {#each letters as letter}
          <button
            ...
            on:click={() =>
              applyFilter({ type: "startingLetter", value: letter })}
          >
            {letter}
          </button>
        {/each}
        ...
        {#each commonTags as tag}
          <button
            ...
            class:active={activeSection === "tag" &&
              $browseTabStore.currentFilter.value === tag}
