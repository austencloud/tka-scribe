<!-- src/lib/components/GalleryTab/DeleteConfirmationDialog.svelte -->
<script lang="ts">
  import { onMount } from "svelte";
  import { fade } from "svelte/transition";

  // Props
  let { type = "variation", sequenceName = "", onconfirm, oncancel } = $props<{
  ...
  >
    ...
    <div class="dialog-content">
      <p id="dialog-description" class="dialog-message">
        {#if type === "sequence"}
          Are you sure you want to delete the entire sequence "{sequenceName}"
