...
<script lang="ts">
  ...
  function handleFavoriteToggle(
    event: CustomEvent<{ sequenceId: string; variationId: string }>
  ) {
...
<div class="browse-tab">
  <div class="browse-tab-content">
    ...
    <div class="sequence-grid-container">
      ...
      {:else if $browseTabStore.error}
        <div class="error-container">
          ...
          <button
            class="retry-button"
            on:click={() => browseTabStore.loadInitialData()}
          >
            Retry
          </button>
        </div>
    ...
    <div
      ...
      class:hidden={!$selectedSequenceData.sequence}
    >
