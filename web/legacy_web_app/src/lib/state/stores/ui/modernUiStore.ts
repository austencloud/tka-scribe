...
import { createContainer } from "$legacyLib/state/core/modern";
...
import { stateRegistry } from "$legacyLib/state/core/registry";
...
export const uiStoreCompat = stateRegistry.registerStore(
  "ui",
  uiWritableStore,
  {
    persist: true,
