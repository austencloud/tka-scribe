...
export const selectPictographLoadProgress = createSelector(
  ...
  {
    id: "pictograph.loadProgress",
    description: "Current pictograph load progress",
  }
);
...
export const selectPictographComponents = createSelector(
  ...
  {
    id: "pictograph.components",
    description: "Pictograph component loading status",
  }
);
...
export const selectPictographStateHistory = createSelector(
  ...
  {
    id: "pictograph.stateHistory",
    description: "Pictograph state transition history",
  }
);
...
export const selectIsLoading = createSelector(
  ...
  {
    id: "pictograph.isLoading",
    description: "Whether the pictograph is loading",
  }
);
...
export const selectIsComplete = createSelector(
  ...
  {
    id: "pictograph.isComplete",
    description: "Whether the pictograph is completely loaded",
  }
);
...
export const selectHasError = createSelector(
  ...
  {
    id: "pictograph.hasError",
    description: "Whether the pictograph has an error",
  }
);
