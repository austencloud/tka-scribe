...
export const selectBackgroundQuality = createSelector(
  ...
  {
    id: "settings.backgroundQuality",
    description: "Current background quality setting",
  }
);
...
export const selectEnableTransitions = createSelector(
  ...
  {
    id: "settings.enableTransitions",
    description: "Enable transitions setting",
  }
);
