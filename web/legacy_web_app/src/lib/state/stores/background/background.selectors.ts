...
export const selectIsBackgroundVisible = createSelector(
  ...
  {
    id: "background.isVisible",
    description: "Whether the background is visible",
  }
);
...
export const selectBackgroundPerformanceMetrics = createSelector(
  ...
  {
    id: "background.performanceMetrics",
    description: "Background performance metrics",
  }
);
...
export const selectHasBackgroundError = createSelector(
  ...
  {
    id: "background.hasError",
    description: "Whether there is a background error",
  }
);
...
export const selectBackgroundWarnings = createSelector(
  derived(
    backgroundStore,
    ($store) => $store.performanceMetrics?.warnings || []
  ),
