...
export const selectContentVisible = createSelector(
  ...
  {
    id: "app.contentVisible",
    description: "Whether the main content is visible",
  }
);
...
export const selectInitializationError = createSelector(
  ...
  {
    id: "app.initializationError",
    description: "Error message from initialization",
  }
);
...
export const selectIsLoading = createSelector(
  useSelector(
    appService,
    (snapshot) =>
      snapshot.matches("initializingBackground") ||
      snapshot.matches("initializingApp")
  ),
...
export const selectIsInitializingApp = createSelector(
  ...
  {
    id: "app.isInitializingApp",
    description: "Whether the app is initializing",
  }
);
...
export const selectHasInitializationFailed = createSelector(
  useSelector(appService, (snapshot) =>
    snapshot.matches("initializationFailed")
  ),
  {
    id: "app.hasInitializationFailed",
    description: "Whether initialization has failed",
  }
);
