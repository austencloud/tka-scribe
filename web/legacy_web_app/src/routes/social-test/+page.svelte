...
<script lang="ts">
	import { isAuthenticated } from '$legacyLib/services/auth';
  ...
  import { 
    ...
    postToTikTok, 
    postToFacebookGroup 
  } from '$legacyLib/services/social/SocialMediaService';
...
<div class="container">
  ...
  <div class="status-section">
    ...
    <ul>
      ...
      <li>
        Instagram:
        <span
          class={isInstagramAuthenticated
            ? "authenticated"
            : "not-authenticated"}
        >
      ...
      <li>
        TikTok:
        <span
          class={isTikTokAuthenticated ? "authenticated" : "not-authenticated"}
        >
  ...
  <div class="note-section">
    <h3>Notes</h3>
    <p>
      This page tests the social media integration functionality. When you click
      on a test button:
    </p>
    <ul>
      <li>
        If you're not authenticated, you'll be redirected to the platform's
        login page
      </li>
      <li>If you are authenticated, a simulated post will be attempted</li>
      <li>
        In a real implementation, the post would be sent to the platform's API
      </li>
    </ul>
  </div>
</div>
