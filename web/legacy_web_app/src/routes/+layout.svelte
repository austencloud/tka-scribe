<script lang="ts">
  ...
  import { initializePictographData } from "$legacyLib/stores/pictograph/pictographStore";
  ...
  // import '$legacyLib/pwa';
  // Import ServiceProvider for DI
  import ServiceProvider from "$legacyLib/providers/ServiceProvider.svelte";
  // Import ToastManager for notifications
  import ToastManager from "$legacyLib/components/shared/ToastManager.svelte";
  // Import dev tools initializers
  // Import safe area CSS
  import "$legacyLib/styles/safe-area.css";
  // Import SafeAreaVisualizer for development
  import SafeAreaVisualizer from "$legacyLib/components/dev/SafeAreaVisualizer.svelte";
