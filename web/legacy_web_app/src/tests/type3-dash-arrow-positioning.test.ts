...
import { PictographService } from "$legacyLib/components/Pictograph/PictographService";
...
import { DASH, PRO, RED, BLUE } from "$legacyLib/types/Constants";
import ArrowLocationManager, {
  calculateDashLocation,
} from "$legacyLib/components/objects/Arrow/ArrowLocationManager";
