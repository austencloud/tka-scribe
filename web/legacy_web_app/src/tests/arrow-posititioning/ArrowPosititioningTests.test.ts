...
import { ArrowPlacementManager } from "$legacyLib/components/objects/Arrow/ArrowPlacementManager";
...
import { PictographChecker } from "$legacyLib/components/Pictograph/services/PictographChecker";
