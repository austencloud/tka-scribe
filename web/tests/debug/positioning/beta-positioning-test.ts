...
async function testBetaPositioning() {
  ...
  const { resolve, TYPES } = await import(
    "../../../src/lib/shared/inversify/container"
  );
  const propPlacementService = resolve(
    TYPES.IPropPlacementService
  ) as import("../../../src/lib/shared/pictograph/prop/services/contracts/IPropPlacementService").IPropPlacementService;
