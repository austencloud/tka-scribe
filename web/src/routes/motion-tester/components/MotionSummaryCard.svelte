...
-->
<script lang="ts">
	import type { MotionTesterState } from '../state/motion-tester-motionState.svelte';
					...
					<div class="motion-details">
						...
						{:else}
							<div class="quick-stats">
								...
								{#if motionState.blueMotionParams.turns > 0}
					...
					<div class="motion-details">
						...
						{:else}
							<div class="quick-stats">
								...
								{#if motionState.redMotionParams.turns > 0}
									<span class="stat-chip turns">
