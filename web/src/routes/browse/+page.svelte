...
<svelte:head>
  ...
  <meta name="description" content="Explore hundreds of kinetic typography animations in the TKA gallery. Browse by difficulty, length, style, and more. Find inspiration for your projects." />
  <meta property="og:title" content="Browse Animations - TKA Gallery" />
  <meta property="og:description" content="Explore hundreds of kinetic typography animations. Browse by difficulty, length, style and find inspiration." />
