...
export class PageFactoryService implements IPageFactoryService {
  ...
  createPages(sequences: SequenceData[], options: PageCreationOptions): Page[] {
    ...
    const pageDimensions = this.layoutService.calculatePageDimensions(
      layoutConfig.printConfiguration.paperSize,
      layoutConfig.printConfiguration.orientation
    );
    const margins = layoutConfig.printConfiguration.margins;
    ...
    sequenceGroups.forEach((sequenceGroup, index) => {
      ...
      const page: Page = {
        ...
        layout: gridConfig,
        pageNumber,
        paperSize: layoutConfig.printConfiguration.paperSize,
        orientation: layoutConfig.printConfiguration.orientation,
        margins: margins,
      };
