...
// Re-export types
export type { ActiveRightPanel, GridMode } from "$lib/state/construct-tab-state.svelte";
...
export const state = {
  get activeRightPanel() { return legacyConstructTabState.activeRightPanel; },
  get gridMode() { return legacyConstructTabState.gridMode; },
  get isTransitioning() { return legacyConstructTabState.isTransitioning; },
  get isSubTabTransitionActive() { return legacyConstructTabState.isSubTabTransitionActive; },
  get currentSubTabTransition() { return legacyConstructTabState.currentSubTabTransition; },
  get errorMessage() { return legacyConstructTabState.errorMessage; },
  get shouldShowStartPositionPicker() { return legacyConstructTabState.shouldShowStartPositionPicker; },
  
  // Setters for legacy compatibility
  set activeRightPanel(value) { legacyConstructTabState.setActiveRightPanel(value); },
  set gridMode(value) { legacyConstructTabState.setGridMode(value); },
  set isTransitioning(value) { legacyConstructTabState.setTransitioning(value); },
  set errorMessage(value) { value ? legacyConstructTabState.setError(value) : legacyConstructTabState.clearError(); },
};
...
export const updateShouldShowStartPositionPicker = legacyConstructTabState.updateShouldShowStartPositionPicker;
