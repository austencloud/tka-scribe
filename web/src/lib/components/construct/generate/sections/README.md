...
- `generateConfigState.svelte.ts` - Configuration state
- `generateActionsState.svelte.ts` - Action handlers
- `generateDeviceState.svelte.ts` - Device detection and responsive behavior
