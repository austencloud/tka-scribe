<!--
FilterPanel - Gallery Filtering and Sorting Controls
...
<script lang="ts">
  ...
  import { GallerySortMethod } from "../../shared/domain/enums/gallery-enums";

  // ✅ PURE RUNES: Props using modern Svelte 5 runes
  const {
    currentFilter = { type: "all", value: null },
    currentSort = GallerySortMethod.ALPHABETICAL,
    sortDirection = "asc",
    onFilterChange = () => {},
    onSortChange = () => {},
  } = $props<{
    currentFilter?: { type: string; value: GalleryFilterValue };
    currentSort?: GallerySortMethod;
    sortDirection?: "asc" | "desc";
    onFilterChange?: (type: string, value?: GalleryFilterValue) => void;
    onSortChange?: (method: GallerySortMethod, direction: "asc" | "desc") => void;
  }>();
  ...
  const sortOptions = [
    { id: GallerySortMethod.ALPHABETICAL, label: "Alphabetical" },
    { id: GallerySortMethod.difficultyLevel, label: "Difficulty" },
    { id: GallerySortMethod.dateAdded, label: "Date Added" },
    { id: GallerySortMethod.sequenceLength, label: "Length" },
  ];
  ...
  let localSort = $state<GallerySortMethod>(currentSort);
  ...
  // Apply a sort
  function applySort(method: GallerySortMethod, direction: "asc" | "desc") {
  ...
  function isFilterActive(type: string, value?: GalleryFilterValue): boolean {
