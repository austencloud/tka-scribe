...
import type {
  ...
  DeleteResult, SequenceData
} from "$shared";
import { injectable } from "inversify";
import type { ISequenceDeleteService } from "../contracts/ISequenceDeleteService";


@injectable()
export class SequenceDeleteService implements ISequenceDeleteService {
