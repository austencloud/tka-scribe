...
import type { IBeatRenderingService, IDifficultyBadgeRenderer, IDimensionCalculationService, IImageCompositionService, ILayoutCalculationService, IUserInfoRenderer, IWordTextRenderer } from "../contracts";
