...
interface EmptyBeatOptions {
  showPlaceholder?: boolean;
  placeholderText?: string;
}

interface ErrorBeatOptions {
  showError?: boolean;
  errorMessage?: string;
...
interface FallbackRenderResult {
  success: boolean;
  canvas?: HTMLCanvasElement;
  error?: string;
}

interface IBeatFallbackRenderer {
  ...
  renderFallback(beat: BeatData, canvas: HTMLCanvasElement, options?: FallbackRenderOptions): Promise<FallbackRenderResult>;
