...
// import type { IBrowseStatePersister } from "../../modules/browse/gallery/services/implementations/BrowseStatePersister"; // Path doesn't exist
...
class MainTabState implements IMainTabState {
  ...
  private _browseStatePersister: any | null = null; // TODO: Use IBrowseStatePersister when available
  ...
  get browseStatePersistence(): any {
    // TODO: Return IBrowseStatePersister when available
    if (!this._browseStatePersister) {
      this._browseStatePersister = resolve(TYPES.IBrowseStatePersister);
    }
    // TypeScript knows this is not null after the check above
    return this._browseStatePersister;
  }
