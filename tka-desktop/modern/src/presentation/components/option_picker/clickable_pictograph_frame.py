...
class ClickablePictographFrame(QFrame):
    ...
    def __init__(self, beat_data: BeatData, parent: Optional[QWidget] = None) -> None:
        ...
        # Start with a default size - will be overridden by sizing coordinator
        default_size: int = 100  # Temporary size until coordinator sets the real size
    ...
    def set_container_widget(self, container_widget: QWidget) -> None:
        """Set the container widget for sizing calculations"""
        self.container_widget = container_widget

    def set_unified_size(self, size: int) -> None:
        """Set pictograph to a specific unified size (used by coordinator)"""
