...
class TestDateSortingFunctionality:
    ...
    def sequence_browser_panel(self, mock_services):
        ...
        with patch(
            "presentation.tabs.browse.components.sequence_browser_panel.QWidget.__init__"
        ):
    ...
    def test_date_section_key_formatting(
        self, sequence_browser_panel, test_sequences_with_dates
    ):
        ...
        section_key = sequence_browser_panel._get_section_key(
            seq_with_date, "date_added"
        )
        assert (
        ...
        section_key2 = sequence_browser_panel._get_section_key(
            seq_with_date2, "date_added"
        )
        assert (
        ...
        section_key3 = sequence_browser_panel._get_section_key(
            seq_without_date, "date_added"
        )
    ...
    def test_date_section_grouping(
        self, sequence_browser_panel, test_sequences_with_dates
    ):
    ...
    def test_date_section_navigation_list(
        self, sequence_browser_panel, test_sequences_with_dates
    ):
        ...
        ), f"Expected {expected_sections}, got {section_names}"

    def test_non_date_sorting_unaffected(
        self, sequence_browser_panel, test_sequences_with_dates
    ):
