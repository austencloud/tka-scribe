...
class TimeBasedTheme(BaseTheme):
    ...
    def generate_palette(self) -> Dict[str, Any]:
        ...
        adjusted_palette = self._apply_temperature_shift(base_palette, temperature_shift)
    ...
    def _apply_temperature_shift(self, palette: Dict[str, str], shift: float) -> Dict[str, str]:
