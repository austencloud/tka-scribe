/**
 * Generate 450px animated versions for big props and guitar
 * These props are intentionally larger than the standard 300px
 */
...
console.log("🎨 Generating 450px animated versions for big props...\n");
...
bigProps.forEach((propName) => {
  ...
  try {
    ...
    console.log(`   ✅ Created animated/${propName}.svg at 450px`);
  } catch (error) {
    console.log(`   ❌ Error: ${error.message}`);
  }
});

console.log("\n✨ Done! All big props now at 450px width");
