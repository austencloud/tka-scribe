...
PERMUTATION_TYPES = {
    ...
    "strict_inverted": "Complementary",
    "swapped_inverted": "Swapped / Complementary",
    "mirrored_swapped": "Mirrored / Swapped",
    "rotated_inverted": "Rotated / Complementary",
    "mirrored_inverted": "Mirrored / Complementary",
    "rotated_swapped": "Rotated / Swapped",
    "mirrored_rotated": "Mirrored / Rotated",
    "mirrored_inverted_rotated": "Mir / Comp / Rot",
    # "rotated_swapped_inverted": "Rotated / Swapped / Complementary",
    # "mirrored_swapped_inverted": "Mirrored / Swapped / Complementary",
    # "mirrored_rotated_swapped": "Mirrored / Rotated / Swapped",
    # "mirrored_rotated_inverted_swapped": "Mirrored / Rotated / Complementary / Swapped",
}
if TYPE_CHECKING:
...
class CAPPicker(QWidget):
    ...
    def _create_layout(self):
        ...
        buttons = [
            ...
            ("swapped_inverted", 1, 1),
            ("rotated_inverted", 1, 2),
            ("mirrored_inverted", 1, 3),
            ("rotated_swapped", 2, 0),
            ("mirrored_rotated", 2, 1),
            ("mirrored_inverted_rotated", 2, 2),
            # ("rotated_swapped_inverted", 2, 3),
            # ("mirrored_swapped_inverted", 3, 0),
            # ("mirrored_rotated_swapped", 3, 1),
            # ("mirrored_rotated_inverted_swapped", 3, 2),
        ]
