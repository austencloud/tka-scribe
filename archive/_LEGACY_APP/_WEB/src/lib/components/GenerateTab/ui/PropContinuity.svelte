...
<script lang="ts">
    import { settingsStore, propContinuity } from '../store/settings';
    ...
    // Get current option
    $: currentOption = continuityOptions.find(opt => opt.id === $propContinuity) || continuityOptions[0];
  </script>
  ...
  <div class="prop-continuity">
    ...
    <div class="toggle-control">
      <button id="prop-continuity-toggle" type="button" class="toggle-track" on:click={toggleContinuity} aria-label="Toggle Prop Continuity">
