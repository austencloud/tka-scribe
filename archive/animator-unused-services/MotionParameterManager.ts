import type { AnimatedMotionParams, MotionData } from "$shared";
import {
  createMotionData,
  GridLocation,
  MotionColor,
...
import type { IMotionParameterManager } from "../contracts";
...
@injectable()
export class MotionParameterService implements IMotionParameterManager {
